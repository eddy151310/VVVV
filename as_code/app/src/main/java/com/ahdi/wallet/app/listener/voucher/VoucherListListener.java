 ...
 * @author zhaohe
 */
public class VoucherListListener implements HttpReqTaskListener {

    private static final String TAG = "VoucherListListener";

    private VoucherSdkCallBack callBack;

    public VoucherListListener(VoucherSdkCallBack callBack) {
    ...
    public void onPostExecute(JSONObject json) {
        if (json != null) {
            LogUtil.e("VoucherListRsp:",json.toString());
        }
        VoucherListRsp resp = VoucherListRsp.decodeJson(VoucherListRsp.class, json);
        if (resp != null) {
