 ...
 * 上传用户头像
 */
public class UpUserPhotoListener implements HttpReqTaskListener {

    private static final String TAG = UpUserPhotoListener.class.getSimpleName();

    private UserSdkCallBack callBack;

    public UpUserPhotoListener(UserSdkCallBack callBack) {
    ...
    public void onPostExecute(JSONObject json) {
        ...
        UpUserPhotoRsp resp = UpUserPhotoRsp.decodeJson(UpUserPhotoRsp.class, json);
        if (callBack == null) {
    ...
    public void onError(JSONObject json) {
        LogUtil.e(TAG, json == null ? TAG + "onError(JSONObject json)" : json.toString());
        if (callBack != null) {
