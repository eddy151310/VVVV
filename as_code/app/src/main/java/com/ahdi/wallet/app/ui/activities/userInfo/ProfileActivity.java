...
public class ProfileActivity extends AppBaseActivity {
    ...
    private void initData() {
        ...
        if (!TextUtils.isEmpty(userData.getAvatar())) {
            ImageDownUtil.downMySelfPhoto(ProfileActivity.this, userData.getAvatar(), iv_user_photo);
        }
    ...
    private void selectPhotoFrom() {
        selectPhotoView = new SelectPhotoView(ProfileActivity.this);
    ...
    private void getPhoto(int type) {
        TakePhotoMain.getInstance().takePhoto(ProfileActivity.this, type, new TakePhotoCallBack() {
    ...
    private void getPhotoUpUrl(Bitmap resultBitmap) {
        ...
        UserSdk.getPhotoUpUrl(ProfileActivity.this, GlobalApplication.getApplication().getSID(), new UserSdkCallBack() {
            @Override
            public void onResult(String code, String errorMsg, JSONObject jsonObject) {
                if (TextUtils.equals(code, UserSdk.LOCAL_PAY_SUCCESS)) {
                    ...
                    if (TextUtils.equals(code, Constants.LOCAL_RET_CODE_NETWORK_EXCEPTION)) {
                        ToastUtil.showToastShort(ProfileActivity.this, errorMsg);
                    } else {
    ...
    private void upPhoto(String upUrl, int type, byte[] imgByte) {
        ...
        UserSdk.upUserPhoto(ProfileActivity.this, upUrl, imgByte, new UserSdkCallBack() {
            @Override
            public void onResult(String code, String errorMsg, JSONObject jsonObject) {
                if (TextUtils.equals(code, UserSdk.LOCAL_PAY_SUCCESS)) {
    ...
    private void setUserIcon(String relativePath, int type) {
        ...
        AppMain.getInstance().setUserIcon(ProfileActivity.this, schema, new UserSdkCallBack() {
            @Override
            public void onResult(String code, String errorMsg, JSONObject jsonObject) {
                closeLoading(loadingDialog);
                if (TextUtils.equals(code, UserSdk.LOCAL_PAY_SUCCESS)) {
    ...
    private void modifyUserInfo(int type) {
        Intent intent = new Intent(ProfileActivity.this, ModifyUserInfoActivity.class);
    ...
    private void updateUserInfo(String content, int type) {
        ...
        AppMain.getInstance().updateUserInfo(ProfileActivity.this, content, type, new UserSdkCallBack() {
            @Override
            public void onResult(String code, String errorMsg, JSONObject jsonObject) {
                closeLoading(loadingDialog);
                if (TextUtils.equals(code, UserSdk.LOCAL_PAY_SUCCESS)) {
