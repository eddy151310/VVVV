 ...
 * @author zhaohe
 */
public class ResetLoginPwdListener implements HttpReqTaskListener {

    private static final String TAG = ResetLoginPwdListener.class.getSimpleName();

    private UserSdkCallBack callBack;

    public ResetLoginPwdListener(UserSdkCallBack callBack) {
    ...
    public void onPostExecute(JSONObject json) {
        ...
        ResetLoginPwdRsp resp = ResetLoginPwdRsp.decodeJson(ResetLoginPwdRsp.class, json);
