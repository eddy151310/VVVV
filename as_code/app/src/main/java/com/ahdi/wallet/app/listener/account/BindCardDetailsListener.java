...
public class BindCardDetailsListener implements HttpReqTaskListener {

    private static final String TAG = BindCardDetailsListener.class.getSimpleName();

    private BankCardSdkCallBack callBack;

    public BindCardDetailsListener(BankCardSdkCallBack callBack) {
    ...
    public void onPostExecute(JSONObject json) {
        ...
        BindCardDetailsRsp resp = SelectCardTypeRsp.decodeJson(BindCardDetailsRsp.class, json);
        if (resp != null) {
