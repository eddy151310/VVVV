...
//            throw new RuntimeException("MD5签名过程中出现错误,指定的编码集不对,您目前指定的编码集是:" + charset);
            throw new RuntimeException("There is an error in the process of the MD5 signature, " +
                    "the specified code set wrong, you now specify code set is:" + charset);
        }
    }
    ...
    public static String md5(String content) {
        ...
        try {
            ...
            LogUtil.e("MD5", "MD5 签名错误:" + e.toString());
        }
        return null;
    }
