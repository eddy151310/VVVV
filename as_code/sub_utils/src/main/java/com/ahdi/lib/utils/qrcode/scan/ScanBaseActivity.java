package com.ahdi.lib.utils.qrcode.scan;
...
import com.ahdi.lib.utils.qrcode.decode.DecoderSDK;
import com.ahdi.lib.utils.qrcode.scan.camera.CameraManager;
import com.ahdi.lib.utils.qrcode.scan.decode.MainHandler;
 ...
 * Author: kay lau
 */
public abstract class ScanBaseActivity extends AppBaseActivity implements SurfaceHolder.Callback {
    ...
    public void checkResult(final String result) {
        ...
        if (TextUtils.isEmpty(result)) {
            showToast(getString(R.string.Toast_S0));
            reInitCamera();
