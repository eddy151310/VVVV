...
public final class CameraManager {
    ...
    public synchronized void openDriver(SurfaceHolder holder) throws IOException {
        ...
        try {
            ...
            // Driver failed
            LogUtil.e(TAG, "Resetting to saved camera params: " + parametersFlattened);
            // Reset:
            if (parametersFlattened != null) {
                ...
                try {
                    ...
                    // Well, darn. Give up
                    LogUtil.e(TAG, "Camera rejected even safe-mode parameters! No configuration");
                }
            }
        }
