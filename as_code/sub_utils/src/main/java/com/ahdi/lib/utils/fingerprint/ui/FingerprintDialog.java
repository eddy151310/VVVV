package com.ahdi.lib.utils.fingerprint.ui;
...
import com.ahdi.lib.utils.fingerprint.core.FingerprintCore;
import com.ahdi.lib.utils.fingerprint.core.FingerprintMain;
import com.ahdi.lib.utils.fingerprint.util.FingerprintConstants;
import com.ahdi.lib.utils.fingerprint.util.FingerprintSPUtil;
...
public class FingerprintDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if (verifyType == FingerprintSDK.FINGERPRINT_LOGIN_START
            ...
            tv_fingerprint_title.setText(tv_fingerprint_title.getResources().getString(R.string.FingerPrint_A0));
            tv_fingerprint_msg.setText(tv_fingerprint_msg.getResources().getString(R.string.FingerPrint_B0));
            ...
            tv_fingerprint_title.setText(tv_fingerprint_title.getResources().getString(R.string.FingerPrint_A0));
            tv_fingerprint_msg.setText(tv_fingerprint_msg.getResources().getString(R.string.FingerPrint_C0));
        }
    ...
    private void showError() {
        ...
        tv_fingerprint_title.setText(tv_fingerprint_title.getResources().getString(R.string.FingerPrint_D0));
    }
            ...
            try {
                ...
                for (Map.Entry<String, Object> entry : keys.entrySet()) {
                    ...
                    if (TextUtils.equals(key, RSAHelper.PUBLIC_KEY)) {
                        ...
                        publicKeyStr = android.util.Base64.encodeToString(publicKey.getEncoded(), android.util.Base64.DEFAULT);
                        ...
                        privateKeyStr = android.util.Base64.encodeToString(pkcs1Key.getEncoded(), android.util.Base64.DEFAULT);
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
